...
function Checkout(){
  ...
  return(
    ...
    <div style={{background:bg,minHeight:"100vh",paddingBottom:200}}>
      ...
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:480,padding:"16px 20px 36px",background:card,borderTop:`1px solid ${dk?"#1e293b":"#f1f5f9"}`,boxSizing:"border-box",boxShadow:"0 -4px 20px rgba(0,0,0,0.08)"}}>
